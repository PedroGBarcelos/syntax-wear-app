...
export const Route = createFileRoute('/_app/products/$productId')({
    ...
    head: ({params}) => {
        ...
        const title = filteredProduct ? `${filteredProduct.name} - Produtos - SyntaxWear` : 'Produto não encontrado - Produtos - SyntaxWear';
...
function RouteComponent() {
    ...
    if (!filteredProduct) return (
        <section className='container text-black mb-10 pt-44 md:pt-54 pb-10 md:px-10 text-center min-h-[80vh] flex flex-col items-center justify-center'>
            <h1 className='text-3xl font-bold mb-4'>Produto não encontrado</h1>
            <p className='0 mb-6'>O produto que você está procurando não existe ou foi removido.</p>
    ...
    const inInstallmentPrice = discountPrice / 6;
            ...
            <div className='flex justify-center gap-10'>
                ...
                <div className='text-black'>
                    ...
                    <p className='text-sm text-[#878787]'>
                        Você econimiza: <span className='font-semibold'>10%</span>
                    </p>

                    <p className='mb-2'>ou<span className='text-[#38373A] font-semibold'>6x</span> de {" "} <span className='text-[#38373A] font-semibold'>{formatCurrency(inInstallmentPrice)}</span>
                    </p>
