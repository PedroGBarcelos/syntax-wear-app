...
function RouteComponent() {
    return (
        <section className='container'>
            ...
            <div>
                <h1 className='text-black text-2xl max-w-7xl m-auto my-20 text-center'>Nossas lojas são o coração da nossa marca. Explore a coleção mais recente, experimente seus modelos favoritos e sinta o conforto da SyntaxWear pessoalmente.</h1>
